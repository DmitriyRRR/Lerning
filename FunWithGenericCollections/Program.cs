...
namespace FunWithGenericCollections
{
    ...
    public class CarName
    {
        ...
        public CarName() { }
        public CarName(int prodyear, string brand, string model )
        {
        ...
        public override string ToString()
        {
                ...
                return $"Car: {Brand} {Model}, prod.: {ProductYear}";
    ...
    class Program
    {
        ...
        private static void UseGenericList()
        {
            ...
            List<CarName> cars = new List<CarName>()
            {
                new CarName { Brand = "BMW", Model = "X5", ProductYear = 2015},
                new CarName { Brand = "Pagani", Model = "Zonda", ProductYear = 2010},
                new CarName { Brand = "Fiat", Model = "Uno", ProductYear = 1994},
                new CarName { Brand = "Bentley", Model = "Arnage T", ProductYear = 2002 },
            };
            Console.WriteLine($"Total cars on sale: {cars.Count}\n");
            // Print out # of items in List.
                        CarName[] arrayOFCars = cars.ToArray();

            cars.Insert(3, new CarName { Brand = "ZAZ", Model = "968M", ProductYear = 1968});
            Console.WriteLine($"Total cars on sale: {cars.Count}\n");
            cars.

            foreach (CarName c in cars)
            {
                Console.WriteLine(c);
            }
            Console.WriteLine();
            ...
            Console.WriteLine();
            foreach (CarName c in arrayOFCars)
            {
                Console.WriteLine(c);
            }
